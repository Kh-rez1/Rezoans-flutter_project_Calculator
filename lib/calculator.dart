...
class _calculatorState extends State<calculator> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
          title: Center(
              child: Text("scientific_calculator_created_by_Khandaker_Rezoanul_Haque_212-15-4204",
                  style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold))),
          backgroundColor: Color.fromARGB(255, 205, 206, 197)),
      body: SafeArea(
        child: Padding(
